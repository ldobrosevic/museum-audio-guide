...
<body>
	...
	<div class="container">
		<form:form action="${pageContext.request.contextPath}/exhibitDetails/${exhibitId}"
			...
			<input type="text" name="name" placeholder="Name of detail" autofocus required />
			<textarea name="description" placeholder="Description of detail"
				cols="79" rows="5" required></textarea>
			
			<p><strong>Slika detalja:</strong> <form:input class="imageUpload" type="file"  path="files[0].file" id="files[0].file"/></p>
			
			<p><strong>Audio zapis detalja: </strong><form:input class="audioUpload" type="file" path="files[1].file" id="files[1].file"/></p>
