...
<body>
	...
	<div class="container">
		<form:form action="${pageContext.request.contextPath}/exhibitions"
			...
			<p class="title">Dodavanje izložbe</p>
			<input type="text" name="name" placeholder="Name of exhibitions" autofocus required />
			<textarea name="description" placeholder="Description of exhibition"
				cols="79" rows="5" required></textarea>
			
			<p><strong>Datum početka:</strong> <input class="imageUpload" name="begin" type="date"  required></p>
			<p><strong>Datum završetka:</strong> <input class="imageUpload" name="end" type="date"  required></p>
			
			<p><strong>Vrsta izložbe: </strong><select class="audioUpload" name="chosen">
			...
			<button type="submit" name="Upload">
       			 <i class="spinner"></i>
        		<span class="state">Dodaj izložbu</span>
     		 </button>
