		...
		<nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				<ul class="navbar-nav mr-auto">
					...
					<li class="nav-item active"><a class="nav-link" href="/aboutus">O
							muzeju</a></li>
			...
			<div class="row h-100">
				<div class="col-12 my-auto">
					<div class="masthead-content text-white py-5 py-md-0">
						<h1 class="mb-3" style="color: black;">O muzeju</h1>
						<p class="mb-5" style="color: black;">
							Muzej muzeja je online vodič kroz raznolike tipove izložbi. Od <strong>kostura
								dinosaura</strong> do <strong>Picassa i Van Gogha</strong>, kod nas ima
							svega! Uključite se u iskustvo dubljeg istraživanja svakog
							izloška i detalja u muzeju uz posebne audio vodiče tijekom
							posjeta izložbi, te naše virtualne izložbe na stranici.
						</p>
					</div>
				</div>
			</div>
