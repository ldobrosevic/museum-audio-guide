...
<body>
  ...
  <div class="wrapper">
    <form class="login" name="passRecovery" action="${pageContext.request.contextPath}/forgotPassword" method="post">
      
      <p class="title">Zaboravili ste lozinku?</p>
    	<c:if test="${errorMessage != null }">
			${errorMessage }
		</c:if>
      	
        <input type="email" placeholder="E-mail adresa" name="email" autofocus required/>  
        <i class="fa fa-email"></i>  
      
        <button type=submit name="submit">
 	      <i class="spinner"></i>
          <span class="state">Pokreni obnovu</span>
        </button>
    </form>
  </div>
