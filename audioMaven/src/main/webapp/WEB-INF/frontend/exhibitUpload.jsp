...
<body>
	...
	<div class="container">
		<form:form action="${pageContext.request.contextPath}/exhibits"
			...
			<p class="title">Dodavanje izloška</p>
			<input type="text" name="name" placeholder="Name of exhibit" autofocus required />
			<textarea name="description" placeholder="Description of exhibit"
				cols="79" rows="5" required></textarea>
			
			<p><strong>Slika izloška:</strong> <form:input class="imageUpload" type="file"  path="files[0].file" id="files[0].file"/></p>
			
			<p><strong>Audio zapis izloška: </strong><form:input class="audioUpload" type="file" path="files[1].file" id="files[1].file"/></p>
			
			<button type="submit" name="Upload">
       			 <i class="spinner"></i>
        		<span class="state">Dodaj izložak</span>
     		 </button>
